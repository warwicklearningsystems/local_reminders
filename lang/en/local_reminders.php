...
$string['messageprovider:reminders_due_questionnaire'] = 'Reminder notifications for Questionnaire due events';
$string['messageprovider:reminders_due_assignment'] = 'Reminder notifications for Assignment due events';
$string['messageprovider:reminders_due_quiz'] = 'Reminder notifications for Quiz due events';
...
$string['quiz_enabled'] = 'Quiz Reminders Enabled:';
$string['quiz_enableddescription'] = 'Enable/disable Quiz reminders';
$string['assignment_enabled'] = 'Assignment Reminders Enabled:';
$string['assignment_enableddescription'] = 'Enable/disable Assignment reminders';
$string['questionnaire_enabled'] = 'Questionnaire Reminders Enabled:';
$string['questionnaire_enableddescription'] = 'Enable/disable Questionnaire reminders';
$string['questionnaire_tags'] = 'Questionanaire Tags:';
$string['questionnaire_tagsdescription'] = 'The Questionnaire tags of which reminders should be sent';
